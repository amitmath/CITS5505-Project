...
with app.app_context():
    ...
    user1 = User(
        ...
        title="Project Lead",
        bio="Experienced project lead with a strong background in agile delivery, sprint planning, and cross-functional team coordination. Passionate about building collaborative environments and delivering high-quality software solutions on time.",
    ...
    user2 = User(
        ...
        bio="Creative UI/UX designer focused on crafting intuitive and user-friendly digital experiences. Skilled in wireframing, prototyping, and modern interface design with attention to accessibility and usability.",
    ...
    user3 = User(
        ...
        bio="Backend developer specializing in scalable web applications, REST APIs, and database architecture. Enjoys solving complex technical problems and building reliable backend systems using modern development practices.",
    ...
    user4 = User(
        ...
        bio="Software engineer with experience in full-stack application development and agile teamwork. Interested in designing efficient systems, improving user experiences, and developing maintainable software solutions.",
        location="Perth, Australia",
